...
class AnalysisState(TypedDict, total=False):
    ...
    # =========================================================================
    # REMEDIATION FIELDS (Set by remediation node)
    # =========================================================================
    
    # Whether remediation was attempted
    remediation_attempted: bool
    
    # The corrected answer (if remediation was triggered)
    remediated_answer: Optional[str]
    
    # Explanation of what was corrected
    remediation_explanation: Optional[str]
    
    # The verified context used for remediation
